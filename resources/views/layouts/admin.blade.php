...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <a href="{{ action('Admin\NewsController@home') }}" class="logo me-auto"><img src="{{secure_asset('assets/img/logo.png')}}" alt="ぐり〜んりぷる" class="img-fluid">管理者画面</a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{ action('Admin\NewsController@news') }}">ニュース投稿</a></li>
          <li><a class="nav-link scrollto" href="{{ action('Admin\VoiceController@voice') }}">お客様の声投稿</a></li>
